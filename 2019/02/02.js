...
function GravityAssist(intCodeProgram, noun, verb) {
    ...
    while (opCode != 99) {
        ...
        var posA = intCodeProgram[currPos + 1];
        var posB = intCodeProgram[currPos + 2];
        var storePos = intCodeProgram[currPos + 3];
        switch (opCode) {
            case 1:
...
function partOne() {
    var input = GetInput();
    var result = GravityAssist(input, 12, 2);
...
function partTwo() {
    ...
    for (noun = 0; noun < 99; noun++) {
        for (verb = 0; verb < 99; verb++) {
            var input = GetInput();
            var result = GravityAssist(input, noun, verb);
