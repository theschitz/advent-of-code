...
function SumFuelRequired(listOfLaunchPayloads) {
    var sum = 0;
    listOfLaunchPayloads.forEach(function (mass) {
...
function SumAdditionalFuelRequired(listOfLaunchPayloads) {
    var totalSumOfFuelRequired = 0;
    listOfLaunchPayloads.forEach(function (mass) {
...
function TestSumAddtional() {
    var reqFuel = SumAdditionalFuelRequired([100756]);
    if (reqFuel !== 50346) {
