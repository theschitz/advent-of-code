...
function GravityAssist(intCodeProgram) {
    var currPos = 0;
    while (currPos <= intCodeProgram.length) {
        var opCode = intCodeProgram[currPos];
        var intA = intCodeProgram[currPos + 1];
        var intB = intCodeProgram[currPos + 2];
...
input[1] = 12;
input[2] = 2;
var result = GravityAssist(input);
